...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/*", "video/*", "application/pdf"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for course-materials" ON storage.objects FOR SELECT USING (bucket_id = 'course-materials');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for course-materials" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'course-materials');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for course-materials" ON storage.objects FOR UPDATE USING (bucket_id = 'course-materials');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for course-materials" ON storage.objects FOR DELETE USING (bucket_id = 'course-materials');`
    ];
